...
[the detailed version](architecture-donation-app.md).)_
...
backend, and _that_ is what books the courier. If a pickup ever stalls, this is
...
warehouse with no manual hand-off. _(Whole picture → System Overview doc.)_
